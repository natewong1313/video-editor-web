...
function DialogLink({ text, href }: { text: string; href?: string }) {
  return (
    <RALink className="text-zinc-500 data-[hovered]:text-white text-sm font-medium rounded-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900">
